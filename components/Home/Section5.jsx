    ...
    <>
        <section className='h-fit bg-black pt-[30px]  md:px-[4vw] px-[3vw] grid sm:grid-cols-2 grid-cols-1 gap-4 justify-center items-center'>
            <div className=''>
              ...
              <button className='border-neutral-300 border-2 h-[45px] mb-[20px] rounded-[32px]  px-[10px] text-[14px] font-semibold text-white  sm:text-[16px] md:h-[60px] w-fit md:rounded-[42px] md:px-4 md:text-[20px]'>Sign up Now</button>
            </div>
